-- +migrate Up
-- Initial PingToPass Database Schema
...
-- Drop indexes first
DROP INDEX IF EXISTS idx_user_progress_readiness;
DROP INDEX IF EXISTS idx_user_progress_user;
DROP INDEX IF EXISTS idx_user_answers_recent;
DROP INDEX IF EXISTS idx_user_answers_test;
DROP INDEX IF EXISTS idx_user_answers_session;
DROP INDEX IF EXISTS idx_user_answers_user_question;
DROP INDEX IF EXISTS idx_test_attempts_scores;
DROP INDEX IF EXISTS idx_test_attempts_user;
DROP INDEX IF EXISTS idx_sessions_active;
DROP INDEX IF EXISTS idx_sessions_user;
DROP INDEX IF EXISTS idx_questions_review;
DROP INDEX IF EXISTS idx_questions_difficulty;
DROP INDEX IF EXISTS idx_questions_exam_objective;
DROP INDEX IF EXISTS idx_objectives_parent;
DROP INDEX IF EXISTS idx_objectives_exam;
DROP INDEX IF EXISTS idx_exams_active;
DROP INDEX IF EXISTS idx_exams_vendor;
